//
//  TouristExtraFacilitiesViewController.swift
//  Project
//
...
class TouristExtraFacilitiesViewController: UIViewController {
       ...
       override func viewDidLoad() {
           ...
           for count in 0...remainingFacilitiesFromPreviousVC.count - 1 {
            ...
            if arrayForExtraLabel[count].text != "Empty" {
                arrayForExtraLabel[count].alpha = 1
